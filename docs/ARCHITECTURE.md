...
| F11 — Hardening, docs, release `v3.0.0` | — | pending — **scope expanded 2026-04-29** to include F11-0 (TUI complete control surface, 11 sub-fases F11-0a..k) before F11-1..F11-7 docs/benchmarks/release polish. The TUI shipped in `v3.0-f10` is monitor + locked 6-step crowbar demo; F11-0 lifts it to "100% del faultycmd viejo + campañas + switch entre engines" per the original §F10 criterion. |
