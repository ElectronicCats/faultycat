...
#define CONFIG_TOTAL_LEN                                                                           \
    (TUD_CONFIG_DESC_LEN + 4 * TUD_CDC_DESC_LEN + TUD_VENDOR_DESC_LEN + TUD_HID_DESC_LEN)
...
static const uint8_t s_config_desc[] = {
    ...
    TUD_CDC_DESCRIPTOR(ITF_CDC0_NOTIF, STRID_CDC0, EP_CDC0_NOTIF, 8, EP_CDC0_DATA_OUT,
                       EP_CDC0_DATA_IN, CFG_TUD_CDC_EP_BUFSIZE),

    TUD_CDC_DESCRIPTOR(ITF_CDC1_NOTIF, STRID_CDC1, EP_CDC1_NOTIF, 8, EP_CDC1_DATA_OUT,
                       EP_CDC1_DATA_IN, CFG_TUD_CDC_EP_BUFSIZE),

    TUD_CDC_DESCRIPTOR(ITF_CDC2_NOTIF, STRID_CDC2, EP_CDC2_NOTIF, 8, EP_CDC2_DATA_OUT,
                       EP_CDC2_DATA_IN, CFG_TUD_CDC_EP_BUFSIZE),

    TUD_CDC_DESCRIPTOR(ITF_CDC3_NOTIF, STRID_CDC3, EP_CDC3_NOTIF, 8, EP_CDC3_DATA_OUT,
                       EP_CDC3_DATA_IN, CFG_TUD_CDC_EP_BUFSIZE),
    ...
    TUD_VENDOR_DESCRIPTOR(ITF_VENDOR, STRID_VENDOR, EP_VENDOR_DATA_OUT, EP_VENDOR_DATA_IN, 64),
    ...
    TUD_HID_DESCRIPTOR(ITF_HID, STRID_HID, HID_ITF_PROTOCOL_NONE, sizeof(s_hid_report_desc),
                       EP_HID_IN, CFG_TUD_HID_EP_BUFSIZE, 1),
};
...
bool tud_vendor_control_xfer_cb(uint8_t rhport, uint8_t stage,
    ...
    if (request->bmRequestType_bit.type == TUSB_REQ_TYPE_VENDOR &&
        ...
        return tud_control_xfer(rhport, request, (void*)(uintptr_t)s_ms_os_20, total_len);
    }
    return false;
}
